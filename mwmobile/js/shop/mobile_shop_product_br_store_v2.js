...
var MobileBRStore2 = {
	name : "MobileBRStore22",
	init : function(){
//		MobileBRStore2.fn.addBtnEvent();
		MobileBRStore2.fn.setSubMenuChange();
//		MobileBRStore2.fn.setBrandInit();
		MobileBRStore2.fn.setPageInit();
...
//							MobileBodyStart.goLogin(returnUrl);
	      		  ...
	      		  try{trackPurchaseClick( trackProdcd,'scAdd');}catch(e){}
				}
	        });
		...
		setPageInit : function(){
			MobileCommon.ajax({
				url : GLOBAL_WEB_ROOT + "mobile/shop/mobile_shop_product_br_store_v2_ajax.do",
				type 		: "POST",
...
//						var prodlist = data.object.prodlist;
						MobileBRStore2.fn.setProductList(data.object);
					}
					MobileBRStore2.fn.addBtnEvent();
				}
			});
