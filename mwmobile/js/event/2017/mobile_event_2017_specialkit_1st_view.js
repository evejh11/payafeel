		...
		addBtnEvent : function(){
			$(".kit_apply").unbind("click").click(function(event){
				...
				if(!IS_LOGIN){
					...
					cmAjax({
						url : GLOBAL_WEB_ROOT+"mobile/event/2017/mobile_event_2017_specialkit_1st_checkGrade_ajax.do"
						,data : {
					...
					cmAjax({
						...
						,success : function(data, textStatus){
							if(data.status == "succ"){
								...
								cmAjax({
									url : GLOBAL_WEB_ROOT+"mobile/event/2017/mobile_event_2017_specialkit_1st_save_ajax.do",
									type: "post",
									data: {
											i_sEventcd : $(".span_evtcode").text()
											, i_sFlagKit : i_sKitNm
									...
									success : function(data,textStatus,jqXHR){
										...
										if(data.status == 'succ'){
											...
											showMessageBox({
												message : "짝짝짝! 멤버십 키트 신청이 완료 되었습니다.<br>키트는 <strong>2월 13일</strong> 이후 일괄 배송될 예정입니다."
												, close : function(){
