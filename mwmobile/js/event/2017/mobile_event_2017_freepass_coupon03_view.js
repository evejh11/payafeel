...
var MobileFreePassCoupon03 = {
	name : "MobileFreePassCoupon03",
	init : function(){
		MobileFreePassCoupon03.fn.addBtnEvent();
	},
	fn : {
		addBtnEvent : function(){
			$(".btn_coupon1").unbind("click").click(function(event){
				if(!IS_LOGIN){
					...
					MobileFreePassCoupon03.fn.goCheck();
				}
			});
		},
		...
		goCheck : function(){
			...
			clickflag = true;
			cmAjax({
				url : GLOBAL_WEB_ROOT + "mobile/event/2017/mobile_event_2017_freepass_coupon03_check_ajax.do"
				, type : "post"
				, dataType : "json"
