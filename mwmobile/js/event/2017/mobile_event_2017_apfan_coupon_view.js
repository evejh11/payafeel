var MobileApxFANCoupon = {
	name : "MobileApxFANCoupon",
	init : function(){
		MobileApxFANCoupon.fn.addBtnEvent();
	},
	fn : {
		addBtnEvent : function(){
			$(".btn_coupon1").unbind("click").click(function(event){
				...
				if(!IS_LOGIN){
					...
					var id = $(this).attr("id");
					MobileApxFANCoupon.fn.saveCoupon(id);
				}
			});
		},
		saveCoupon : function(id){
			cmAjax({
				url : GLOBAL_WEB_ROOT + "mobile/event/2017/mobile_event_2017_apfan_coupon_check_ajax.do",
				dataType :"json",
