	...
	fn : {
		...
		addBtnEvent : function(){
			...
			$(".a_goApp_sns").unbind("click").click(function(event){
				...
				var url = "http://www.amorepacificmall.com/mobile/my/mobile_my_all_direct_list.do?i_sFlagSnsBrowser=Y";
			...
			MobileCommon.ajax({
				...
				success  : function(data, textStatus, jqXHR){
					if(data.status == 'succ'){
						...
						location.href = GLOBAL_SSL_URL+"mobile/my/mobile_my_all_direct_list.do";
					}
