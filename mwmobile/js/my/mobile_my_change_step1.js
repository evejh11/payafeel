...
var MobileMyChangeStep1 ={
	name : "MobileMyChangeStep1"
	,init : function(){
		$(".contView").eq(0).show();
		$(".contView").eq(1).show();
		MobileMyChangeStep1.addBtnEvent();
		MobileMyChangeStep1.OrderView();
	},
	addBtnEvent : function(){
		...
		$(".btn_change_address").click(function(event){
...
//											arrHtml.push("			<span class='span_fg_cnt'>"+freeVo[j].n_product_cnt+"개</span>");		
						...
						if(cpsize > 0){
							...
							for(var i=0; i<cpsize; i++){
								...
								arrHtml.push("		<div class='prodImg prodImg_bd'>");
								arrHtml.push("			<span class='inputChk6'>");
								arrHtml.push("				<input type='checkbox' id='chkc_"+(i+1)+"' name='i_arrSeqno' value='"+cpVo[i].v_n_seqno+"' class='checkbox check_"+cpVo[i].v_product_typecd+"' checked='checked'>");
...
//								}
						...
						if(giftsize > 0){
							...
							for(var i=0; i<giftsize; i++){
								...
								arrHtml.push("		<div class='prodImg prodImg_bd'>");
								arrHtml.push("			<span class='inputChk6'>");
								arrHtml.push("				<input type='checkbox' id='chkb_"+(i+1)+"' name='i_arrSeqno' value='"+giftVo[i].n_seqno+"' class='checkbox check_"+giftVo[i].v_product_typecd+"' checked='checked'>");
...
//								}
						...
						if(specialsize > 0){
							...
							for(var i=0; i<specialsize; i++){
								...
								arrHtml.push("		<div class='prodImg prodImg_bd'>");
								arrHtml.push("			<span class='inputChk6'>");
								arrHtml.push("				<input type='checkbox' id='chks_"+(i+1)+"' name='i_arrSeqno' value='"+specialVo[i].n_seqno+"' class='checkbox check_"+specialVo[i].v_product_typecd+"' checked='checked'>");
...
//								}
						...
						if(pointsize > 0){
							...
							for(var i=0; i<pointsize; i++){
								...
								arrHtml.push("		<div class='prodImg prodImg_bd'>");
								arrHtml.push("			<span class='inputChk6'>");
								arrHtml.push("			<input type='checkbox' id='chkp_"+(i+1)+"' name='i_arrSeqno' value='"+pointVo[i].n_seqno+"' class='checkbox check_"+pointVo[i].v_product_typecd+"' checked='checked'>");
...
//						}
						...
						if(vipsize > 0){
							...
							for(var i=0; i<vipsize; i++){
								...
								arrHtml.push("		<div class='prodImg prodImg_bd'>");
								arrHtml.push("		<span class='inputChk6'>");
								arrHtml.push("			<input type='checkbox' id='chkv_"+(i+1)+"' name='i_arrSeqno' value='"+vipVo[i].n_seqno+"' class='checkbox check_"+vipVo[i].v_product_typecd+"' checked='checked'>");
								arrHtml.push("			<label for='chkv_"+(i+1)+"'>");
...
//								}
					...
					MobileMyChangeStep1.setPayStats(rvo, pgVo, giftcardVo, giftboxCnt);
					MobileMyChangeStep1.addBtnEvent();
				}else{
