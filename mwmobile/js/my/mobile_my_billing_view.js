var MobileMyBillingView ={
	name : "MobileMyBillingView"
	,init : function(){
		
		MobileMyBillingView.OrderView();
		MobileMyBillingView.addBtnEvent();
		MobileMyBillingView.isDeliveryKeyup();
	},
	addBtnEvent : function(){
		...
		$(".btn_lettering_confirm").click(function(event){
			...
			MobileMyBillingView.NamingLayerPopup();
		...
		$(".btn_cancel_pop").click(function(event){
			event.preventDefault();
			// 정기구독 해지안내 팝업열기
		...
		$(".btn_cancel").click(function(event){
			event.preventDefault();
				...
				MobileCommon.ajax({
					url : GLOBAL_WEB_ROOT+"mobile/my/mobile_my_billing_cancel_save.do"
					, type : "POST"
		...
		$(".btn_delivery_reg").click(function(event){
			...
			if(MobileMyBillingView.isDeliveryValidation()){
	...
	OrderView : function(){
		...
		MobileCommon.ajax({  
			url : GLOBAL_WEB_ROOT+"mobile/my/mobile_my_billing_view_ajax.do"
			, type : "POST"
			, dataType : "json"
			...
			, success : function( data, textStatus, jqXHR) {
				...
				if(data.status == "succ"){
					...
					MobileMyBillingView.setPayStats(rvo, pgVo, giftcardVo, giftboxCnt);
...
//				arrHtml.push("</tr>");
			...
			billHTML.push("    <dd>신용카드_" + pgVo.v_financename + "</dd>                                     ");
